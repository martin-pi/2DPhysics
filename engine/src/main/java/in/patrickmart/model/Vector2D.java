...
public class Vector2D {
    ...
    public static void test() {
        ...
        v.set(4, 3);
        System.out.println("v.set(4, 3) => Vector\nv = " + v.toString());
        Vector2D w = u.copy();
        System.out.println("w = u.copy() => Vector\nw = " + w.toString());
        w.random();
        System.out.println("w.random() => Vector\nw = " + w.toString());
        w.fromAngle(1);
        System.out.println("w.fromAngle(1) => Vector\nw = " + w.toString());
        System.out.println("Note: w is a unit vector. w.mag() = " + w.mag());
        // Vector Math --------------------------------------------------------------------------------
        System.out.println("Vector Math --------------------------------------------------------------------------------");
        v.add(u);
        System.out.println("v + u = " + v.toString());
        v.sub(u);
        System.out.println("v - u = " + v.toString());
        v.mult(2);
        System.out.println("v * 2 = " + v.toString());
        v.div(2);
        System.out.println("v / 2 = " + v.toString());
        ...
        System.out.println("v.mag() => " + v.mag());
        System.out.println("v.magSq() => " + v.magSq());
        System.out.println("w.heading() => " + w.heading());
        System.out.println("v.dist(u) => " + v.dist(u));
        System.out.println("u.dist(v) => " + u.dist(v));
        System.out.println("v.angleBetween(u) => " + v.angleBetween(u));
        System.out.println("u.angleBetween(v) => " + u.angleBetween(v));
        System.out.println("u.x => " + u.x);
        System.out.println("u.y => " + u.y);
        System.out.println("v.array() => double[]");
        // Vector Modification ------------------------------------------------------------------------
        System.out.println("Vector Modification ------------------------------------------------------------------------");
        w.setMag(5);
        System.out.println("w.setMag(5) => Vector2D\nw.mag() => " + w.mag());
        w.limit(2);
        System.out.println("w.limit(2) => Vector2D\nw.mag() => " + w.mag());
        w.normalize();
        System.out.println("w.normalize() => Vector2D\nw.mag() => " + w.mag());
        u.set(1, 0);
        System.out.println("u.set(1, 0) => Vector2D\nu = " + u.toString());
        u.rotate(Math.PI / 2);
        System.out.println("u.rotate(Math.PI / 2) => Vector\nu => " + u.toString());
        // Static Methods -----------------------------------------------------------------------------
        System.out.println("Static Methods -----------------------------------------------------------------------------");
        Vector2D q = new Vector2D(10, 40);
        Vector2D r = new Vector2D(5, -12);
        System.out.println("q = " + q.toString() + "\nr = " + r.toString());
        System.out.println("Vector2D.addVectors(q, r) => " + Vector2D.addVectors(q, r).toString());
